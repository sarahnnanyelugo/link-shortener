...
import Marriot from "../../assets/images/marriot.svg";
...
function Home() {
  return (
    <>
      ...
      <center>
        <h1>Loved by big and small brands everywhere</h1>
      </center>
      <center>
        {" "}
        <img className="   logo" src={Novasol} alt="Scholar" width="100%" />
        <img className="   logo" src={BigFIshl} alt="Scholar" width="100%" />
        <img className="   logo" src={Marriot} alt="Scholar" width="100%" />
        <img className="   logo" src={York} alt="Scholar" width="100%" />
        <img className="   logo" src={Arts} alt="Scholar" width="100%" />
      </center>
    </>
  );
}
