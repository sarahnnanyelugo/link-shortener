    ...
    <>
      ...
      <center>
        ...
        <div className="partners">
          <img className="  partners " src={Novasol} alt="Scholar" />
          <img className="  partners" src={BigFIshl} alt="Scholar"  />
          <img className=" partners  " src={Marriot} alt="Scholar" />
          <img className="partners  " src={York} alt="Scholar"  />
          <img className="partners  arts" src={Arts} alt="Scholar"  />
        </div>
      </center>
      <div className="col-md-8 offset-md-2">
        <FAQAccordionBlue />
