    ...
    <>
      ...
      <center>
        ...
        <div className="partners">
          <img className="   " src={Novasol} alt="Scholar" width="15%" />
          <img className="  " src={BigFIshl} alt="Scholar" width="15%" />
          <img className="   " src={Marriot} alt="Scholar" width="15%" />
          <img className="  " src={York} alt="Scholar" width="15%" />
          <img className="  " src={Arts} alt="Scholar" width="15%" />
        </div>
      </center>
    </>
  );
