...
function Home() {
  return (
    <>
      ...
      <center>
        <h2 style={{marginTop:"50px";}}>Loved by big and small brands everywhere</h2>
      </center>
      <center>
        {" "}
        <div className="partners">
          <img className="   " src={Novasol} alt="Scholar" width="10%" />
          <img className="  " src={BigFIshl} alt="Scholar" width="10%" />
          <img className="   " src={Marriot} alt="Scholar" width="10%" />
          <img className="  " src={York} alt="Scholar" width="10%" />
          <img className="  arts" src={Arts} alt="Scholar" width="10%" />
        </div>
      </center>
      <div className="col-md-8 offset-md-2">
        <FAQAccordionBlue />
