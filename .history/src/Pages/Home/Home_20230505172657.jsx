  ...
  return (
    <>
      ...
      <center>
        {" "}
        <div>
          <img className="   logo" src={Novasol} alt="Scholar" width="20%" />
          <img className="   logo" src={BigFIshl} alt="Scholar" width="10%" />
          <img className="   logo" src={Marriot} alt="Scholar" width="10%" />
          <img className="   logo" src={York} alt="Scholar" width="10%" />
          <img className="   logo" src={Arts} alt="Scholar" width="10%" />
        </div>
      </center>
    </>
  );
