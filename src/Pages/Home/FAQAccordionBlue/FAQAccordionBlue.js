      ...
      <Accordion defaultActiveKey="">
        <Accordion.Item eventKey="0">
          ...
          <Accordion.Body>
            <p>
              ...
              <br /> Think of a short URL as a more descriptive and memorable
              nickname for your long webpage address. You can, for example, use
              a short URL like bit.ly/CelebrateBitly so people will have a good
              idea about where your link will lead before they click it. <br />
              If you’re contributing content to the online world, you need a URL
              shortener. <br />
        ...
        <Accordion.Item eventKey="2">
          ...
          <Accordion.Body>
            ...
            <p>
              For example, instead of bit.ly/2m75BWD, you could use a custom
              short URL like yourbrnd.co/2m75BWD.
            </p>
            <p>
            ...
            <p>
              A link shortening service that includes custom short URLs is vital
              to improving audience engagement with your communications. A short
        ...
        <Accordion.Item eventKey="5">
          ...
          <Accordion.Body>
            <p>
              ...
              content and your audience ignite action. orm.
            </p>
            <p>
              It’s why the most recognized brands in the world love our platf
            </p>
            <button className="accord-get-started">Get started today</button>
          </Accordion.Body>
        </Accordion.Item>
      </Accordion>
    </div>
